...
<p align="center">
  <strong>A Minesweeper game for the Numworks calculator</strong>
</p>
...
2. Connectez votre calculatrice Numworks à votre ordinateur via un câble USB de données (cable officiel ou compatible).
...
> [!NOTE]
> S'il elle n'est pas détectée et qu'elle est bien allumée, éteignez-la puis rallumez-la jusqu'a ce que ça marche, ça peut prendre plusieur tentatives
...
9. L'application **Minesweeper** devrait maintenant être visible tout en bas de la list des applications (après les app de base) de votre calculatrice.


## Pourquoi ce projet ?

Par ce que une application externe en code machine est beaucoup plus performante que un script Python,
et bien plus beau grace a la possibilité d'utiliser des images.

Aussi car ce projet est essentiellement dev pour le fun, et pour m'améliorer en Rust.
